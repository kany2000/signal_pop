#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Signal Pop 定时发布 20260809 → 8/10 08:00 (抖音 + 快手 + B站，sau CLI)
注意：sau 不支持知乎，知乎需手动发布。
"""
...
DATE = "20260809"
OUT_DIR = "E:/projects/signal_pop/output/daily_20260809"   # 文案与封面目录
VIDEO_DIR = "E:/projects/signal_pop/output/daily/20260809"  # 视频目录
SAU = ["sau"]
ACCOUNT = "her2home"
SCHEDULE = "2026-08-10 08:00"
BILI_TID = 249

VIDEO = os.path.join(VIDEO_DIR, f"signal_pop_daily_{DATE}.mp4")
COVER_34 = os.path.join(OUT_DIR, "cover_20260810_3x4.png")
COVER_169 = os.path.join(OUT_DIR, "cover_20260810_16x9.png")
