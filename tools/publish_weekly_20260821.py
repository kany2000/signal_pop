#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Signal Pop 周末特别版定时发布 20260821 → 8/22 周六 08:00 (抖音 + 快手 + B站，sau CLI)
...
DATE = "20260821"
OUT_DIR = "E:/projects/signal_pop/output/weekly/20260821"   # 文案与封面目录
VIDEO_DIR = "E:/projects/signal_pop/output/weekly/20260821"  # 视频目录
SAU = ["sau"]
ACCOUNT = "her2home"
SCHEDULE = "2026-08-22 08:00"
BILI_TID = 249
...
print(f"\n定时发布时间: {SCHEDULE}")
print("📌 知乎/小红书/Facebook/YouTube/Twitter：sau 不支持或需单独登录，需手动发布。")
