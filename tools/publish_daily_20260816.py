#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Signal Pop 定时发布 20260816 → 8/17 周一 08:00 (抖音 + 快手 + B站，sau CLI)
注意：sau 不支持知乎；小红书需单独登录。发布范围：仅抖音/快手/B站。
"""
...
DATE = "20260816"
OUT_DIR = "E:/projects/signal_pop/output/daily/20260816"
VIDEO_DIR = "E:/projects/signal_pop/output/daily/20260816"
SAU = ["sau"]
ACCOUNT = "her2home"
SCHEDULE = "2026-08-17 08:00"
BILI_TID = 249

VIDEO = os.path.join(VIDEO_DIR, f"signal_pop_daily_{DATE}.mp4")
COVER_34 = os.path.join(OUT_DIR, f"cover_20260817_3x4.png")
COVER_169 = os.path.join(OUT_DIR, f"cover_20260817_16x9.png")
...
results["bilibili"] = run("bilibili", SAU + [
    ...
    "--tags", "信号弹,隔天信号弹,每日新闻,AI新闻,科技,财经,Windows11,SpaceX,法拉利", "--tid", str(BILI_TID),
    "--schedule", SCHEDULE,
])
