...
COMMENTS = {
    ...
    # —— 以下为 20260912 期新增：CIPS + 苹果秋季发布会全系 ——
    "news_15.jpg": {
        "xiaolan": "11家外资银行接入，连卢旺达都覆盖到了，人民币这朋友圈是越扩越大。",
        "axin": "CIPS把人民币跨境结算的网络再往外扩，国际化底盘又稳了一层，长期看是慢功夫。",
    },
    "news_16.jpg": {
        "xiaolan": "4800万可变光圈主摄，拍照党狂喜，就是9999起步的价格也挺\"Pro\"的。",
        "axin": "可变光圈解决的是弱光和景深这两块硬骨头，Pro线继续往上堆料，9月18号就能上手。",
    },
    "news_17.jpg": {
        "xiaolan": "手表陶瓷都回归了，Ultra 4还能扛50小时，运动党这下有的挑了。",
        "axin": "S11芯片加陶瓷回归，Ultra 4把续航拉到50小时，户外和健身场景的护城河又深了。",
    },
    "news_18.jpg": {
        "xiaolan": "999块就有主动降噪，通勤党福音，地铁里终于能清净了。",
        "axin": "把ANC下放到入门线，降噪的门槛又被苹果自己拉低一截，竞品压力不小。",
    },
    "news_19.jpg": {
        "xiaolan": "库克交棒后第一场发布会，连标准版都砍了，苹果这是all in高端啊。",
        "axin": "Ternus首秀定调\"亮新篇\"，产品重心全面倒向Pro和折叠；发布会当天股价小跌0.28%，市场还在观望新班子。",
    },
}
