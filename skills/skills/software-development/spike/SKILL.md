...
metadata:
  hermes:
    ...
    related_skills: [sketch, writing-plans, subagent-driven-development, plan, prototype]
---
...
## Alternative Patterns (lightweight)

For simpler prototype scenarios that don't need the full GSD spike workflow, two lightweight branches are available:

- **Logic prototype** — when the question is "does this state model feel right?". See [references/alternative-prototype-patterns.md](references/alternative-prototype-patterns.md).
- **UI prototype** — when the question is "what should this look like?". See [references/alternative-prototype-patterns.md](references/alternative-prototype-patterns.md).
